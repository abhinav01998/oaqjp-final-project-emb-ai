...
def emotion_detector(text_to_analyze):
    ...
    dominant_emotion = list(json_response['emotionPredictions'][0]['emotion'].keys())
                        [list(json_response['emotionPredictions'][0]['emotion'].values()).index(highest_emotion_score)]
